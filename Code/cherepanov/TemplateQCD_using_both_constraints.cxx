#include "TemplateQCD_using_both_constraints.h"
...
TemplateQCD_using_both_constraints::TemplateQCD_using_both_constraints(TString Name_, TString id_):
  Selection(Name_,id_)
{
}

TemplateQCD_using_both_constraints::~TemplateQCD_using_both_constraints(){
  for(int j=0; j<Npassed.size(); j++){
    std::cout << "TemplateQCD_using_both_constraints::~TemplateQCD_using_both_constraints Selection Summary before: " 
	 << Npassed.at(j).GetBinContent(1)     << " +/- " << Npassed.at(j).GetBinError(1)     << " after: "
	 << Npassed.at(j).GetBinContent(NCuts) << " +/- " << Npassed.at(j).GetBinError(NCuts) << std::endl;
  }
  std::cout << "TemplateQCD_using_both_constraints::~TemplateQCD_using_both_constraints()" << std::endl;
}

void  TemplateQCD_using_both_constraints::Configure(){
  // Setup Cut Values
...
void  TemplateQCD_using_both_constraints::Store_ExtraDist(){
...
void  TemplateQCD_using_both_constraints::doEvent(){
