#ifndef TemplateSignal_Using_Muon_angleNoPU_h
#define TemplateSignal_Using_Muon_angleNoPU_h
...
class TemplateSignal_Using_Muon_angleNoPU : public Selection {

 public:
  TemplateSignal_Using_Muon_angleNoPU(TString Name_, TString id_); 
  virtual ~TemplateSignal_Using_Muon_angleNoPU();
