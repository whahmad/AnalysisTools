#include "TemplateQCD_Using_3prongMomenta.h"
...
TemplateQCD_Using_3prongMomenta::TemplateQCD_Using_3prongMomenta(TString Name_, TString id_):
  Selection(Name_,id_)
{
}

TemplateQCD_Using_3prongMomenta::~TemplateQCD_Using_3prongMomenta(){
  for(int j=0; j<Npassed.size(); j++){
    std::cout << "TemplateQCD_Using_3prongMomenta::~TemplateQCD_Using_3prongMomenta Selection Summary before: " 
	 << Npassed.at(j).GetBinContent(1)     << " +/- " << Npassed.at(j).GetBinError(1)     << " after: "
	 << Npassed.at(j).GetBinContent(NCuts) << " +/- " << Npassed.at(j).GetBinError(NCuts) << std::endl;
  }
  std::cout << "TemplateQCD_Using_3prongMomenta::~TemplateQCD_Using_3prongMomenta()" << std::endl;
}

void  TemplateQCD_Using_3prongMomenta::Configure(){
  // Setup Cut Values
...
void  TemplateQCD_Using_3prongMomenta::Store_ExtraDist(){
...
void  TemplateQCD_Using_3prongMomenta::doEvent(){
