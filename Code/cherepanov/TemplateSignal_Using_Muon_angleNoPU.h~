#ifndef TemplateSignal_Using_Muon_angle_h
#define TemplateSignal_Using_Muon_angle_h
...
class TemplateSignal_Using_Muon_angle : public Selection {

 public:
  TemplateSignal_Using_Muon_angle(TString Name_, TString id_); 
  virtual ~TemplateSignal_Using_Muon_angle();
