#include "TemplateSignal_Using_Muon_angle.h"
...
TemplateSignal_Using_Muon_angle::TemplateSignal_Using_Muon_angle(TString Name_, TString id_):
  Selection(Name_,id_)
{
}

TemplateSignal_Using_Muon_angle::~TemplateSignal_Using_Muon_angle(){
  for(int j=0; j<Npassed.size(); j++){
    std::cout << "TemplateSignal_Using_Muon_angle::~TemplateSignal_Using_Muon_angle Selection Summary before: " 
	 << Npassed.at(j).GetBinContent(1)     << " +/- " << Npassed.at(j).GetBinError(1)     << " after: "
	 << Npassed.at(j).GetBinContent(NCuts) << " +/- " << Npassed.at(j).GetBinError(NCuts) << std::endl;
  }
  std::cout << "TemplateSignal_Using_Muon_angle::~TemplateSignal_Using_Muon_angle()" << std::endl;
}

void  TemplateSignal_Using_Muon_angle::Configure(){
  // Setup Cut Values
...
void  TemplateSignal_Using_Muon_angle::Store_ExtraDist(){
...
void  TemplateSignal_Using_Muon_angle::doEvent(){
  ...
  //  std::cout<<"---------->>>PU reweigh:   " << w <<std::endl;
