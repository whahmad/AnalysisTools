...
void  ZtoEMu_ABCD::Configure(){
  ...
  wjets_control_a=HConfig.GetTH1D(Name+"_wjets_control_a","wjets_control_a",40,20.,140.,"m_{e,#mu} / GeV");
...
void  ZtoEMu_ABCD::doEvent(){
  ...
  if(muidx!=999
	  ...
	  value.at(ptbal) = (Ntp->Muons_p4(muidx)+Ntp->Electron_p4(eidx)).Pt();
  }
