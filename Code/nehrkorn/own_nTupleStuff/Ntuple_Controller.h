...
class Ntuple_Controller{
 ...
 public:
  ...
  std::vector<float> Vtx_Track_Weights(unsigned int i){return Ntp->Vtx_Track_Weights->at(i);}
  ...
  std::vector<int> Vtx_Corr_Track_idx(unsigned int i);
  ...
  //Base Tau Information (PF)
   ...
   TLorentzVector   KFTau_TauFitInitial_p4(unsigned int i){return TLorentzVector(Ntp->KFTau_TauFitInitial_p4->at(i).at(1),Ntp->KFTau_TauFitInitial_p4->at(i).at(2),Ntp->KFTau_TauFitInitial_p4->at(i).at(3),Ntp->KFTau_TauFitInitial_p4->at(i).at(0));}
   ...
   TLorentzVector   KFTau_NeutrinoInitial_p4(unsigned int i){return TLorentzVector(Ntp->KFTau_NeutrinoInitial_p4->at(i).at(1),Ntp->KFTau_NeutrinoInitial_p4->at(i).at(2),Ntp->KFTau_NeutrinoInitial_p4->at(i).at(3),Ntp->KFTau_NeutrinoInitial_p4->at(i).at(0));}
...
/*   std::vector<std::vector<float> > KFTau_Fit_InitialPrimaryVertex; */
   ...
   std::vector<int>   PFJet_Corr_Track_idx(unsigned int i);
   ...
   TLorentzVector             MC_p4(unsigned int i){return TLorentzVector(Ntp->MC_p4->at(i).at(1),Ntp->MC_p4->at(i).at(2),Ntp->MC_p4->at(i).at(3),Ntp->MC_p4->at(i).at(0));}
   int                        MC_pdgid(unsigned int i){return Ntp->MC_pdgid->at(i);}
   int                        MC_charge(unsigned int i){return Ntp->MC_charge->at(i);}
   unsigned int               MC_midx(unsigned int i){return Ntp->MC_midx->at(i);}
   std::vector<int>           MC_childpdgid(unsigned int i){return Ntp->MC_childpdgid->at(i);}
   ...
   bool electronhasJetOverlap(unsigned int electron_idx,unsigned int &jet_idx);
   bool electronhasJetMatch(unsigned int electron_idx,unsigned int &jet_idx);
   ...
   float    Electron_Track_dR(unsigned int i){return Ntp->Electron_Track_dR->at(i);}
   float    Electron_MVA_discriminator(unsigned int i){return Ntp->Electron_MVA_discriminator->at(i);}
   int		Electron_NMVA(){return Ntp->Electron_MVA_discriminator->size();}

   bool               isTightElectron(unsigned int i);
   bool               isTightElectron(unsigned int i, unsigned int j);
   bool               isGoodElectron(unsigned int i);
   bool               isGoodElectron(unsigned int i, unsigned int j);
   bool               isFakeElectron(unsigned int i, unsigned int j);
   float              Electron_RelIso(unsigned int i);
   float              Electron_Aeff(float Eta);
