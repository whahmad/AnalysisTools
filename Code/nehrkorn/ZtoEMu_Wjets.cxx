...
void  ZtoEMu_Wjets::Configure(){
  ...
  wjets_a=HConfig.GetTH1D(Name+"_wjets_a","wjets_a",2,0.,2.,"number of entries");
  wjets_b=HConfig.GetTH1D(Name+"_wjets_b","wjets_b",2,0.,2.,"number of entries");
  wjets_c=HConfig.GetTH1D(Name+"_wjets_c","wjets_c",2,0.,2.,"number of entries");
  wjets_d=HConfig.GetTH1D(Name+"_wjets_d","wjets_d",2,0.,2.,"number of entries");
...
void  ZtoEMu_Wjets::Store_ExtraDist(){
	...
	Extradist1d.push_back(&wjets_d);
	Extradist1d.push_back(&wa);
	Extradist1d.push_back(&wb);
	Extradist1d.push_back(&wc);
	Extradist1d.push_back(&wd);
	Extradist1d.push_back(&wjets_control_a);
	Extradist1d.push_back(&wjets_control_b);
	Extradist1d.push_back(&wjets_control_c);
	Extradist1d.push_back(&wjets_control_d);
...
bool ZtoEMu_Wjets::isWWElectron(unsigned int i, unsigned int j){
	double mvapt = Ntp->Electron_p4(i).Pt();
	double mvaeta = fabs(Ntp->Electron_supercluster_eta(i));
...
double ZtoEMu_Wjets::TriggerEff(unsigned int muid, unsigned int eid, TString path){
	double eff = 1.;
...
double ZtoEMu_Wjets::SingleEle(unsigned int i){
	double pt = Ntp->Electron_p4(i).Pt();
	double eta = fabs(Ntp->Electron_supercluster_eta(i));
	double eff = 1.;
...
double ZtoEMu_Wjets::DoubleEleLeading(unsigned int i){
	double pt = Ntp->Electron_p4(i).Pt();
	double eta = fabs(Ntp->Electron_supercluster_eta(i));
	double eff = 1.;
...
double ZtoEMu_Wjets::DoubleEleTrailing(unsigned int i){
	double pt = Ntp->Electron_p4(i).Pt();
	double eta = fabs(Ntp->Electron_supercluster_eta(i));
	double eff = 1.;
...
double ZtoEMu_Wjets::SingleMu(unsigned int i){
	double pt = Ntp->Muon_p4(i).Pt();
	double eta = fabs(Ntp->Muon_p4(i).Eta());
	double eff = 1.;
...
double ZtoEMu_Wjets::DoubleMuLeading(unsigned int i){
	double pt = Ntp->Muon_p4(i).Pt();
	double eta = fabs(Ntp->Muon_p4(i).Eta());
	double eff = 1.;
...
double ZtoEMu_Wjets::DoubleMuTrailing(unsigned int i){
	double pt = Ntp->Muon_p4(i).Pt();
	double eta = fabs(Ntp->Muon_p4(i).Eta());
	double eff = 1.;
...
void ZtoEMu_Wjets::Finish(){
	...
	wc.at(0).SetBinContent(1,wjets_c.at(0).GetBinContent(1));
	wd.at(0).SetBinContent(1,wjets_d.at(0).GetBinContent(1));
	for(unsigned int i=1;i<nhistos;i++){
		wa.at(0).SetBinContent(1,wa.at(0).GetBinContent(1)-wjets_a.at(i).GetBinContent(1)*scale.at(i));
		wb.at(0).SetBinContent(1,wb.at(0).GetBinContent(1)-wjets_b.at(i).GetBinContent(1)*scale.at(i));
		wc.at(0).SetBinContent(1,wc.at(0).GetBinContent(1)-wjets_c.at(i).GetBinContent(1)*scale.at(i));
		wd.at(0).SetBinContent(1,wd.at(0).GetBinContent(1)-wjets_d.at(i).GetBinContent(1)*scale.at(i));
	}
	wjets.at(0).SetBinContent(1,1,wa.at(0).Integral());
